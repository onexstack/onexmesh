...
import (
	...
	apiappsv1 "github.com/onexstack/onexmesh/examples/apis/apps/v1"
	exampleclient "github.com/onexstack/onexmesh/examples/pkg/generated/exampleclient"
	internalinterfaces "github.com/onexstack/onexmesh/examples/pkg/generated/exampleclient/informers/internalinterfaces"
	appsv1 "github.com/onexstack/onexmesh/examples/pkg/generated/exampleclient/listers/apps/v1"
...
func NewDeploymentInformer(client exampleclient.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredDeploymentInformer(client exampleclient.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewDeploymentInformerWithOptions(client exampleclient.Interface, namespace string, options internalinterfaces.InformerOptions) cache.SharedIndexInformer {
...
func (f *deploymentInformer) defaultInformer(client exampleclient.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
