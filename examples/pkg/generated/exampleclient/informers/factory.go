...
import (
	...
	apps "github.com/onexstack/onexmesh/examples/pkg/generated/exampleclient/informers/apps"
...
type sharedInformerFactory struct {
	client           exampleclient.Interface
	namespace        string
...
func NewSharedInformerFactory(client exampleclient.Interface, defaultResync time.Duration) SharedInformerFactory {
...
func NewFilteredSharedInformerFactory(client exampleclient.Interface, defaultResync time.Duration, namespace string, tweakListOptions internalinterfaces.TweakListOptionsFunc) SharedInformerFactory {
	return NewSharedInformerFactoryWithOptions(client, defaultResync, WithNamespace(namespace), WithTweakListOptions(tweakListOptions))
}

// NewSharedInformerFactoryWithOptions constructs a new instance of a SharedInformerFactory with additional options.
func NewSharedInformerFactoryWithOptions(client exampleclient.Interface, defaultResync time.Duration, options ...SharedInformerOption) SharedInformerFactory {
