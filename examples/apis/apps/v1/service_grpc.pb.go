...
const (
	DeploymentService_Get_FullMethodName = "/examples.apps.v1.DeploymentService/Get"
)
...
func (c *deploymentServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetReply, error) {
...
func (UnimplementedDeploymentServiceServer) Get(context.Context, *GetRequest) (*GetReply, error) {
...
var DeploymentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.apps.v1.DeploymentService",
	...
	Metadata: "examples/apis/apps/v1/service.proto",
}
