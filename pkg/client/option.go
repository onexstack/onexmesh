...
func WithDiscovery(d registry.Discovery) DialOption {
	return func(o *dialOptions) { o.discovery = d }
}
...
func WithRetryable(f func(error) bool) DialOption {
	return func(o *dialOptions) { o.resilience.retryable = f }
}
...
func WithBulkhead(maxConcurrent int) DialOption {
	return func(o *dialOptions) { o.resilience.maxConcurrent = maxConcurrent }
}
